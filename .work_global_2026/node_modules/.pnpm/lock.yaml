...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.31.tgz':
    resolution: {integrity: sha512-4w7E7OlRE5ieEeDAvJuTpl4Fg/+q8kv/SyqCHRTCVU+vO4TPDGVp3wWlF01HSM12LXOWMrBRzKuUPB2M7g1dvw==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.31.tgz}
    version: 2.8.31
    bundledDependencies:
      - '@oai/embedded-fonts'
      - '@oai/walnut'
